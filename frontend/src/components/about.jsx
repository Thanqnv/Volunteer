...
export default function About() {
  return (
    <div>
        ...
        <div className="lg:flex gap-12 max-w-[1200px] px-6 mx-auto">
          <div className="lg:w-1/2 w-full">
            <span data-aos="fade-up-right">
              <button className="animate-pulse rounded-lg bg-green-500 w-20 h-20 flex justify-center items-center mb-8">
          ...
          >
            <div
              className="border border-gray rounded-lg p-10 flex flex-col items-center gap-4 text-green-500 hover:bg-green-500 hover:text-white transition-bg hover:border-transparent"
      ...
      <div
        className="bg-[url(/bg-line.png)] bg-contain bg-bottom bg-green-500 py-[100px]"
        data-aos="fade-down"
      >
