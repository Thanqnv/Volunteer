...
import { LayoutDashboard, Plane, CalendarDays, User, Users, UserPen, FileText, TicketCheck, Menu, X, ChevronLeft, ChevronRight, LogOut } from 'lucide-react'
    ...
    <>
      ...
      >
        <nav className="p-4">
          ...
          className="mt-4 w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold text-red-400 hover:text-white hover:bg-red-500/10 transition-colors"
        >
