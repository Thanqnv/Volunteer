    ...
    <footer className="bg-[url(/bg-map-2.png)] bg-[#313041] py-16 bg-contain">
      <div className="text-[#A9A8B6] flex lg:flex-nowrap flex-wrap justify-between max-w-[1200px] xl:px-0 px-6 mx-auto gap-10">
          ...
          <div className="border-t border-[#A9A8B6] pt-[15px]">
            <ul className="flex flex-col gap-4">
              <a href="#" className="flex items-center gap-2 hover:text-green-500">
                <MdPhone className="text-green-500" /> +84 123 456 789
              </a>
              <a href="#" className="flex items-center gap-2 hover:text-green-500">
                <MdOutlineMailOutline className="text-green-500" /> qairline-support@qairline.website
              </a>
              <a href="#" className="flex items-center gap-2 hover:text-green-500">
                <MdOutlineLocationOn className="text-green-500" /> Nhà E3, 144 Xuân Thủy, quận Cầu Giấy, Hà Nội , Việt Nam
              </a>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:w-1/3">
          ...
          />
          <button className="mt-2 mb-4 bg-green-500 rounded-lg text-center text-white h-14 outline-none hover:opacity-90">
            ĐĂNG KÝ
          </button>
