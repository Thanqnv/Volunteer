          ...
          <ul className="flex items-center flex-1 justify-center gap-x-8 lg:gap-x-12 max-lg:hidden">
            ...
            <Link
              ...
              className={`leading-normal no-underline text-lg ${
                router.pathname === '/' ? 'text-green-500' : 'hover:text-green-500'
              }`}
            >
              Trang chủ
            </Link>
            ...
            <Link
              href="/contact"
              className={`leading-normal no-underline text-lg ${
                router.pathname === '/contact' ? 'text-green-500' : 'hover:text-green-500'
              }`}
            >
              Liên hệ
            </Link>
            ...
            {isAuthenticated ? (
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="ghost" className="rounded-full bg-[#faf5ee] text-gray w-10 h-10 flex items-center justify-center hover:bg-green-500 hover:text-white p-0">
              ...
              <div className="flex items-center gap-2">
                <Link href="/login">
                  <Button variant="ghost" className="hover:bg-green-500 hover:text-white">
                    Đăng nhập
                  </Button>
                </Link>
                <Link href="/signup">
                ...
                {isAuthenticated ? (
                  <>
                    <li>
                      <Link
                        href="/my-account"
                        className="px-6 h-10 flex items-center leading-normal no-underline font-bold text-lg border-b border-gray-200 text-green-500"
                      >
                        Thông tin tài khoản
                      </Link>
                    </li>
