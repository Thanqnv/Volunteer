        ...
        <div className="h-auto w-full rounded-md bg-white shadow dark:bg-neutral-800">
            ...
            <div className="flex w-full flex-col space-y-2 p-2 px-4">
                ...
                <div className="flex space-x-3 text-sm font-thin text-gray-500">
                    ...
                    <Action className="flex h-8 flex-1 items-center justify-center space-x-2 rounded-md hover:bg-gray-100 focus:bg-gray-200 focus:outline-none dark:text-gray-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" icon="fas fa-thumbs-up" label="Like" />
                    <Action className="flex h-8 flex-1 items-center justify-center space-x-2 rounded-md hover:bg-gray-100 focus:bg-gray-200 focus:outline-none dark:text-gray-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" icon="fas fa-comment" label="Comment" />
                </div>
            </div>
        </div>
    );
