      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="flex items-center p-6">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-muted-foreground">Tổng số thành viên</p>
              <h3 className="text-2xl font-bold">42</h3>
              <p className="text-sm text-green-600 mt-1">Số tình nguyện viên đang hoạt động</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="flex items-center p-6">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-muted-foreground mt-1">Số sự kiện đang mở</p>
              <p className="text-sm text-muted-foreground mt-1">Số sự kiện đang chờ duyệt</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="flex items-center p-6">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-muted-foreground">Tỷ lệ tăng trưởng tình nguyện viên </p>
