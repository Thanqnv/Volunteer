    ...
    <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Thông tin liên hệ */}
          <Card className="space-y-4 border-green-500 border-2">
            <CardHeader>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <span>@vnu.edu.vn</span>
                </div>
              </div>
              
              <h3 className="text-xl font-semibold mt-8 mb-4">Theo Dõi Chúng Tôi</h3>
              <div className="flex space-x-4">
                <a href="" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-green-500">
          ...
          <Card className="space-y-4 border-green-500 border-2">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button variant="text-green-500" type="submit" disabled={dangGui}>
