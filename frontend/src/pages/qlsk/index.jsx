...
export default function LoginForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Tạo tài khoản giả lập
        const mockData = {
            token: "mock-admin-token",
            user: {
                firstName: "John",
                lastName: "Doe",
                email: formData.email || "johndoe@example1.com",
            },
        };
            ...
            >
                <Card className="w-full max-w-md bg-white shadow-xl">
                    <CardHeader className="space-y-1">
                        <CardTitle className="text-3xl font-bold text-center text-green-500">Đăng nhập admin</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <Button type="submit" className="w-full bg-green-500 hover:bg-[#d55643] text-white">
                                Đăng nhập
                            </Button>
                        </form>
                    </CardContent>
